  ...
  return (
    <ParallaxProvider>
      <div className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <section
          id="about"
          className="h-[150vh] px-6 lg:px-12 flex flex-col justify-center items-center text-center bg-neutral-900 relative"
        >
        ...
        <Parallax translateY={["-50vh", "0vh"]} className="relative z-10">
          <div
            id="features"
            className="bg-black px-6 lg:px-12 py-28 min-h-screen"
          >
